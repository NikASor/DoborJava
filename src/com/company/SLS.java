...
public class SLS {
        ...
        try {
            ...
            try (FileWriter fw = new FileWriter("lessons.txt", false);
                ...
                for(Lesson les: lessons){
                    if (lesson.audienceNumber.equals(les.audienceNumber)
    ...
    public void removeLesson(String lesson){
        ...
        for(Lesson lessonTemp:SLS.lessons){
